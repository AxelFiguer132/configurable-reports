...
// 📌 Estado de los segmentos del reporte
const segments = ref([
  { id: "1", name: "Encabezado", type: "Encabezado" },
  { id: "2", name: "Datos", type: "Detalle" },
  { id: "3", name: "Totales", type: "Totales" },
]);

// 📌 Estado del modal para agregar segmento
...
// 📌 Abrir modal de agregar segmento
...
const saveSegment = () => {
  ...
  // Agregar nuevo segmento a la lista
...
// 📌 Redirigir a la configuración del segmento en ConfigReportView
...
// 📌 Volver a la pantalla de lista de reportes
